...
public partial class DialySalesCount : System.Web.UI.Page
{
    ...
    private void getdetails(string CenterCode, int CenterID)
    {
        try
        {
            ...
            DateTime dt = Convert.ToDateTime(txtStartDate.Text.ToString());
            DataSet dsData = objHotLeadBL.GetTotalSalesBycenterByAgentForoneDay(CenterID, dt);
            DataSet dsDataVerifier = objHotLeadBL.GetTotalSalesBycenterByVerifierForoneDay(CenterID, dt);
