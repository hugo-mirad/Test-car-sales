<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddAnotherCar.aspx.cs" Inherits="AddAnotherCar" %>
...
<body>
    ...
    <div class="main" style="border: #ccc 1px solid; padding: 10px; background: rgb(253, 243, 234)">
        <table runat="server" style="width: 100%; text-align: center">
            <tr>
                <td align="center">
                    <h2 style="text-align: center; margin: 0; text-transform: uppercase;">
                        <asp:Label ID="lblHeadingForAddCar" runat="server"></asp:Label></h2>
                </td>
            </tr>
        </table>
