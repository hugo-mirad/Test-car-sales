<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CenterWiseLeadDownload.aspx.cs"
    Inherits="CenterWiseLeadDownload" %>
    ...
    <script type="text/javascript" language="javascript">
     function isNumberKeyForDt(evt) {	
        ...
        function Validate() {
            ...
            var EDate = document.getElementById('txtTo').value;
            ...
            var dtFromDt = document.getElementById('txtFrom').value;
            ...
            var dtTodt = document.getElementById('txtTo').value;
                        ...
                        <ContentTemplate>
                            <table style="width: 100%;" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <table style="width: 270px; float: left; border-collapse: collapse; margin-left: 0px;
                                                        ...
                                                        <tr>
                                                            <td style="width: 45%; padding: 0; text-align: right">
                                                                <asp:TextBox ID="txtFrom" runat="server" class="input1 " MaxLength="10" onkeypress="return isNumberKeyForDt(event)"
                                                                    Width="70px"></asp:TextBox>&nbsp;
                                                                <img id="imgcal" runat="server" style="border-right: 0px; border-top: 0px; border-left: 0px;
                                                                    border-bottom: 0px" title="Calendar Control" onclick="displayCalendar(document.forms[0].txtFrom,'mm/dd/yyyy',this);"
                                                            ...
                                                            <td style="text-align: left; padding: 0;">
                                                                <asp:TextBox ID="txtTo" runat="server" class="input1 " MaxLength="10" onkeypress="return isNumberKeyForDt(event)"
                                                                    Width="70px"></asp:TextBox>&nbsp;
                                                                <img id="img1" runat="server" style="border-right: 0px; border-top: 0px; border-left: 0px;
                                                                    border-bottom: 0px" title="Calendar Control" onclick="displayCalendar(document.forms[0].txtTo,'mm/dd/yyyy',this);"
                                                                    alt="Calendar Control" src="images/Calender.gif" width="18" />
                                ...
                                <tr>
                                    <td>
                                        <br />
                                        <div id="dvLeads" runat="server" style="width: 450px; float: left; display: none;"
                                            visible="false">
                                            <h3>
