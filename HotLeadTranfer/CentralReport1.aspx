<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CentralReport1.aspx.cs" Inherits="CentralReport1" %>
        ...
        <table style="width: 100%">
            ...
            <td>
                <h1 style="border-bottom: none; padding-top: 5px;">
                    UNITED CAR EXCHANGE <span>Center Sales Report</span></h1>
            </td>
            <td style="width: 460px; padding-top: 10px;">
                <div class="loginStat">
                    ...
                    <tr>
                        <td>
                            <table style="float: left; width: 533px; border-collapse: initial; padding: 10px 0 15px 0;
                                border: #ccc 1px solid; margin-right: 15px; height: 94px;">
                                <tr>
                                    ...
                                    <td style="padding-top: 28px;">
                                        <%--<asp:LinkButton ID="lnkAgnetsReport" runat="server" Text="Agents Report" PostBackUrl="~/CenterAgentsReport.aspx"></asp:LinkButton>--%>
                                    </td>
                            ...
                            <table cellpadding="0" cellspacing="0" style="float: left; border-collapse: initial;
                                padding: 10px; border: #ccc 1px solid; height: 94px;" class="table12">
                                <tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <table style="width: 410px; padding: 10px; border-collapse: collapse; border: #ccc 1px solid;
                                float: left; height: 61px; margin-left: 15px; margin-right:15px;">
                                <tr>
