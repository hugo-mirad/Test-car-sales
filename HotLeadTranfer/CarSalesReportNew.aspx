<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarSalesReportNew.aspx.cs"
    Inherits="CarSalesReportNew" %>
...
<body>
    ...
    <asp:UpdateProgress ID="UpdateProgress2" runat="server" AssociatedUpdatePanelID="updtpnltblRdbtns"
        DisplayAfter="0">
        <ProgressTemplate>
            <div id="spinner">
                <h4>
    ...
    <div class="main" style="width: 90%; min-width: 1100px; margin: 0 10px 10px 10px">
        <table style="width: 100%; display: block;" id="tblGrdcar" runat="server">
                            ...
                            <table style="float: left; width: 533px; border-collapse: initial; padding: 10px 0 15px 0;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br />
                                        <asp:DropDownList ID="ddlCenters" runat="server" OnSelectedIndexChanged="ddlCenters_SelectedIndexChanged"
                                            AutoPostBack="true">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="padding-top: 0">
                                        <table id="tblAgents" runat="server" style="display: none;">
                                            <tr>
                                                <td>
                                                    <strong>Agent:</strong>
                                                    <br />
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="updtpnltblRdbtns" runat="server">
                        <ContentTemplate>
                                ...
                                <tr>
                                    <td style="width: 250px;">
                                        <asp:RadioButton ID="rdbtnSales" Text="Sales" GroupName="Option" runat="server" Checked="true"
                                            AutoPostBack="true" OnCheckedChanged="btnSearchMonth_Click" />
                                        <asp:RadioButton ID="rdbtnVerifications" Text="Verifications" GroupName="Option"
                                            runat="server" AutoPostBack="true" OnCheckedChanged="btnSearchMonth_Click" />
                                    </td>
                                    <td>
                                        &nbsp;
                                    </td>
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td colspan="5">
                                <h4 style="margin-bottom: 0; padding-bottom: 0; line-height: 11px; font-size: 14px;">
                                    Agent Performance Report- Summary</h4>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td align="left">
                                <asp:UpdatePanel ID="UpdtpnldatResCounts" runat="server">
                                    <ContentTemplate>
                                        <asp:Label ID="lblAgentRes" Font-Size="12px" Font-Bold="true" ForeColor="Black" runat="server"></asp:Label>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
            ...
            <tr>
                <td style="vertical-align: top;">
                    <div style="width: 100%;" id="divCarresults" runat="server">
                            ...
                            <asp:UpdatePanel ID="UpdtpnlHeader" runat="server">
                                <ContentTemplate>
                                    <table class="grid1 " cellpadding="0" cellspacing="0" style="position: absolute;
                                        top: 2px; width: 780px; background: #fff; border-top: #fff 2px solid;">
                                        <tr class="tbHed">
                                            <td align="left">
                                                Agent
                                            </td>
                        ...
                        <div style="width: 800px; overflow-y: scroll; overflow-x: hidden; padding: 26px 3px 3px 3px;
                            border: #ccc 1px solid; height: 320px">
                            <asp:Panel ID="pnl1" Width="100%" runat="server">
                                <asp:UpdatePanel ID="UpdPnlGrid" runat="server">
                                    <ContentTemplate>
                                        <asp:GridView Width="780px" ID="grdAgentsInfo" runat="server" CellSpacing="0" CellPadding="0"
                                            ...
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblAgent" runat="server" Text='<%#objGeneralFunc.WrapTextByMaxCharacters(DataBinder.Eval(Container.DataItem,"SaleAgent"),30)%>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Left" />
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCenter" runat="server" Text='<%# Eval("AgentCenterCode")%>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Left" Width="60px" />
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSubmitSales" runat="server" Text='<%# Eval("SalesCount")%>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Left" Width="100px" />
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSubmitAmt" runat="server" Text='<%# Bind("SalesAmount", "{0:00.00}") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Left" Width="100px" />
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblFullProcessedCount" runat="server" Text='<%# Eval("PaidCount")%>'></asp:Label>
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Left" Width="100px" />
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblFullProcessedAmt" runat="server" Text='<%# Bind("PaidAmount", "{0:00.00}") %>'></asp:Label>
                                                    </ItemTemplate>
                                    ...
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="grdAgentsInfo" EventName="Sorting" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </asp:Panel>
                        </div>
        ...
        <table>
            <tr>
                <td colspan="5">
                    <h4 style="margin-bottom: 0; padding-bottom: 0; line-height: 11px; font-size: 14px;">
                        Agent Performance Report- Full</h4>
                </td>
            </tr>
        </table>
        <table>
            <tr>
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:Repeater ID="TotalDataRepeater" runat="server" OnItemDataBound="TotalDataRepeater_ItemDataBound">
                                <ItemTemplate>
                                    <div id="divTotalDataRepeater" runat="server">
                                        <strong>Agent name:</strong><asp:Label ID="lblFullAgentName" runat="server" Text='<%# Eval("SaleAgent") %>'></asp:Label>
                                        <asp:HiddenField ID="hdnFullAgentName" runat="server" Value='<%# Eval("SaleAgent") %>' />
                                        <br />
                                        <strong>Center:</strong><asp:Label ID="lblFullAgentCenter" runat="server" Text='<%# Eval("AgentCenterCode") %>'></asp:Label>
                                        <asp:HiddenField ID="hdnFullAgentCenter" runat="server" Value='<%# Eval("AgentCenterCode") %>' />
                                        <br />
                                        <strong>Date range:</strong><asp:Label ID="lblFullDateRange" runat="server"></asp:Label>
                                        <br />
                                        <strong>Date of report:</strong><asp:Label ID="lblFullReportDate" runat="server"></asp:Label>
                                        <br />
                                        <div style="width: 100%;" id="divCarresults" runat="server">
                                            <div style="width: 100%; position: relative; padding: 0 3px; height: 1px">
                                                <asp:UpdatePanel ID="UpdtpnlHeader" runat="server">
