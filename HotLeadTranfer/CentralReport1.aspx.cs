...
public partial class CentralReport1 : System.Web.UI.Page
{
    ...
    private void GetResults(DateTime StartDate, DateTime EndDate)
    {
        try
        {
            ...
            int AgentID = Convert.ToInt32(ddlSaleAgent.SelectedItem.Value);
            ...
            SingleAgentSales = objHotLeadBL.GetAllAgentsSalesDataNewPayment(StartingDate, EndingDate, CenterCode, AgentID, paymentid);
    ...
    protected void lnkbtnPmntStatus_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = Session["AllAgentSales"] as DataSet;
    ...
    protected void lnkAbandonCarIDSort_Click(object sender, EventArgs e)
    {
        try
        {
            Session.Timeout = 180;
            DataSet ds = new DataSet();
            ds = Session["AllAgentAbandonSales"] as DataSet;
            ds.Tables[0].DefaultView.RowFilter = "";
            DataTable dt = ds.Tables[0];
            string SortExp = "carid";
    ...
    protected void lnkbtnTransSaleID_Click(object sender, EventArgs e)
    {
        try
        {
            Session.Timeout = 180;
            DataSet ds = new DataSet();
            ds = Session["AllAgentTransfersIN"] as DataSet;
            ds.Tables[0].DefaultView.RowFilter = "";
            DataTable dt = ds.Tables[0];
            string SortExp = "carid";
            if (Session["SortAbandonDirec"] == null)
    ...
    protected void lnkVerifyCarIDSort_Click(object sender, EventArgs e)
    {
        try
        {
            Session.Timeout = 180;
            DataSet ds = new DataSet();
            ds = Session["AllAgentVerifierSales"] as DataSet;
            ds.Tables[0].DefaultView.RowFilter = "";
            DataTable dt = ds.Tables[0];
            string SortExp = "carid";
            if (Session["SortDirec"] == null)
