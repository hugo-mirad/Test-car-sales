<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BulkProcess.aspx.cs" Inherits="BulkProcess" %>
...
<head id="Head1" runat="server">
    ...
    <style>
        #grdWarmLeadInfo textarea{ width:95%; min-height:50px; display:none; }
    </style>
   ...
   <link href="Static/Css/calender.css" rel="stylesheet" type="text/css" />
    ...
    function ClosePopup() {
         ...
         function ClosePopup19() {
            $find('<%=  MdlStatusResult.ClientID%>').hide();
            return false;
        }
           function ClosePopup19() {
            $find('<%=  MdlPayStat.ClientID%>').hide();
            return false;
        }
        ...
        function ClosePopup() {
         ...
         function ClosePopup5() {
          ...
          function ClosePopup21() {
            $find('<%= MDLPOPLeadsPhn.ClientID%>').hide();
            return false;
        }
 ...
 function isNumberKey(evt)
    ...
    /*
    function NewUrl(this)
    {
        console.log(e.prev())
                //var="http://www.whitepages.com/phone//"
       // window.open("http://www.whitepages.com/phone/1-432-212-9999/");
    }
    */
    
    $(function(){
        $('.whitePages').click(function(){
            var num = $.trim($(this).prev('span').text());
            window.open("http://www.whitepages.com/phone/1-"+num);
        })
    })
...
$(function(){
    ...
    $('#chkall').live('change', function(){
        ...
        if ($(this).is(':checked')) {    
            ...
            $('#grdWarmLeadInfo tr input[type=checkbox]').each(function(){
             ...
             $('#grdWarmLeadInfo textarea').hide().val('');              
    ...
    $('#grdWarmLeadInfo tr input[type=checkbox]').live('change', function(){
                ...
                if ($(this).is(':checked')) {                   
                    ...
                    $(this).parent().parent().removeClass('act');
                    $(this).parent().parent().find('textarea').hide().val('');
                } 
                //$('#hdncheck').val(chkString);
...
<body>
   ...
   <%-- </div>--%>
                    ...
                    <tr style="padding:0;" >
                        <td style="padding:0">
                            <table style="padding:0; width:100%;">
                                <tr>
                                    <td align="left" style="width: 14%; padding:0" width="250px">
                                        <%-- <h2 style="margin: 0; padding: 0;">
                                            Sale(s)</h2>--%>
                                        <asp:Label ID="lblResHead" runat="server" ></asp:Label>
                                    </td>
                                    <td align="left" style="padding:0" width="20px">
                                      ...
                                      <td align="left" style="width: 53%; padding:0 20px 0 0; height:30px;">
                                      <asp:Button id="qcprocess" Text="QC Process" runat="server" CssClass="g-button g-button-submit"  OnClick="qcprocess_Click"/>&nbsp;
                                      <asp:Button id="qcreject" Text="QC Reject" runat="server" Visible="true" CssClass="g-button g-button-submit" OnClick="qcreject_Click"/>&nbsp;
                                      <asp:Button id="qcreturn" Text="QC Return" runat="server" Visible="true" CssClass="g-button g-button-submit" OnClick="qcreturn_Click"/>&nbsp;
                                      <asp:Button id="PProcess" Text="P.Process" runat="server"  Visible="true" CssClass="g-button g-button-submit" OnClick="PProcess_Click"/>&nbsp;
                                      <asp:Button id="PReject" Text="P.Reject" runat="server"  Visible="true" CssClass="g-button g-button-submit" OnClick="PReject_Click"/>&nbsp;
                                      <asp:Button id="Preturn" Text="P.Return" runat="server" Visible="true" CssClass="g-button g-button-submit" OnClick="Preturn_Click"/>&nbsp;
                                      <div class="bulk1" style="display:none;">
                                    ...
                                    <td align="right" style="width: 18%; padding:0 20px 0 0">
                                                     ...
                                                     <asp:TemplateField>
                                                      ...
                                                      <%--For PaymentDetails--%>
                                                        ...
                                                        <%--For CustomerDetails--%>
                                                         <asp:TemplateField>
                                                            <ItemTemplate>
                                                                  <asp:Label ID="lblCusPhn" runat="server"></asp:Label>&nbsp;<%--<asp:LinkButton ID="lblcuscheck" CssClass="whitePages"  runat="server" Text="i" OnClick="lblcuscheck_Click" ></asp:LinkButton>--%>
                                                                  <%--<asp:LinkButton ID="lblcuscheck"  runat="server" Text="W.P" CommandArgument='<%# Eval("carid")%>'
                                                                    CommandName="PhoneMatch" title="Phone Search"></asp:LinkButton>--%>
                                                                    <asp:ImageButton id="lblcuscheck" runat="server" ImageUrl="images/icon-phone.png"  CommandArgument='<%# Eval("carid")%>'
                                                                    CommandName="PhoneMatch" title="Phone Search" />
                                                                  <br />
                                                                  <asp:Label ID="lblCName" runat="server"></asp:Label><br />
                                                                  <asp:Label ID="lblcAdd" runat="server"></asp:Label>
                                                                
                                                                  <asp:ImageButton id="PhoneMatch" runat="server" ImageUrl="images/icon-google_location.png"  CommandArgument='<%# Eval("carid")%>'
                                                                    CommandName="GoogleAddressMatch" title="Google Search" />
                                                                   <%--<asp:LinkButton ID="PhoneMatch"  runat="server" Text="G.S" CommandArgument='<%# Eval("carid")%>'
                                                                    CommandName="GoogleAddressMatch" title="Google Search"></asp:LinkButton><br />--%><br />
                                                                  <asp:Label ID="lblCCity" runat="server"></asp:Label>
                                                                    <asp:ImageButton id="LinkButton2" runat="server" ImageUrl="images/icon-directory.png"  CommandArgument='<%# Eval("carid")%>'
                                                                    CommandName="AddressMatch" title="Address Search" />
                                                                  
                                                                 <%-- <asp:LinkButton ID="LinkButton2"  runat="server" Text="R.S" CommandArgument='<%# Eval("carid")%>'
                                                                    CommandName="AddressMatch"  title="Address Search"></asp:LinkButton>--%><br /> 
                                                         ...
                                                         <asp:TemplateField>
                                                            <ItemTemplate>
                                                                ...
                                                                CommandName="PaymentHistory"></asp:LinkButton><br />
                                                                 <asp:LinkButton ID="leaddetails" runat="server" Text="Lead Details" OnClick="leaddetails_Click"></asp:LinkButton><br />
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                ...
                                                                Transfer : <b><asp:LinkButton ID="lblTransfr" runat="server" CommandArgument='<%# Eval("postingID")%>'
                                                                 ...
                                                                 <asp:TextBox ID="txtEnterNotes" runat="server" TextMode="MultiLine"  ></asp:TextBox>
                                                            </ItemTemplate>
        ...
        <div class="main" style="height: 520px; margin-top: 70px; width: 650px">
            <h4>
                Update Payment Details
                        0 0 3; overflow: scroll; height: 480px;">
    ...
    <div id="divAddAnotherCarAlert" class="alert" style="display: none">
        ...
        <div class="data">
            ...
            <asp:Button ID="btnAddAnotherCarNoN1" class="btn" runat="server" Text="No" OnClick="btnAddAnotherCarNoN1_Click" />&nbsp;
 ...
 <!--Model pop up for Car Description-->
   ...
   <!-- BulkQC Update Edit Result Grid -->
     <!-- QC Status Result -->
   <cc1:ModalPopupExtender ID="MdlStatusResult" runat="server" PopupControlID="tblUpdate15"
        BackgroundCssClass="ModalPopupBG" TargetControlID="Hd1" CancelControlID="BtnClsSendRegMail3" >
    </cc1:ModalPopupExtender>
    ...
    <div id="tblUpdate15" class="PopUpHolder" style="display: none;"  >
        <div class="main" style="width: 1120px" >
            <h4>
                QC Status Results
                <asp:LinkButton ID="BtnClsSendRegMail3" runat="server" Text="Close" BorderWidth="0"
                    CssClass="close"></asp:LinkButton>
                <!-- <div class="cls">
            </div> -->
            </h4>
                            ...
                            <tr>
                                <td style="vertical-align: top;">
                                    <asp:UpdatePanel ID="UpdatePanel36" runat="server">
                                        <ContentTemplate>
                                            <div>
                                                <b>Sale ID:&nbsp;<asp:Label ID="lblQCProcessSaleID" runat="server"></asp:Label></b>
                                            </div>
                                            <div style="width: 100%">
                                            </div>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                    <div style="width: 100%;" id="div5" runat="server">
                                        <div style="width: 100%; position: relative; padding: 0 3px; height: 1px">
                                            ...
                                            <asp:Panel ID="Panel4" Width="100%" runat="server">
                                                <asp:UpdatePanel ID="UpdatePanel38" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:GridView Width="1070px" ID="grid" runat="server" CellSpacing="0" CellPadding="0"
                                                            CssClass="grid1" AutoGenerateColumns="False" GridLines="None" ShowHeader="false"
                                                           OnRowDataBound="grid_RowDataBound">
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblsalesid"  Text='<%# Eval("postingID")%>' runat="server" ></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left" Width="110px" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        ...
                                                                        <asp:Label ID="lblQcresu" runat="server"></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left" Width="90px" />
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtEnterNotes1" runat="server"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left" Width="80px" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="lblpaynotes" runat="server"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left" Width="80px" />
                                                                </asp:TemplateField>
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                       <asp:CheckBox id="lblpaymCheck" runat="server"/>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left" Width="60px" />
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                       <asp:HiddenField id="lblpaymStat" Value='<%# Eval("PSStatusID1")%>' runat="server"/>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Left" Width="60px" />
                                                                </asp:TemplateField>
                                                            </Columns>
            ...
            <td>
             <asp:Button ID="btnPPrc" CssClass="g-button g-button-submit" runat="server"
            Text="Payment Procees"  OnClick="btnPPrc_Click" />
            </td>
            <td>
             <asp:Button ID="btnQcClos" CssClass="g-button g-button-submit" runat="server"
            Text="Close" OnClientClick="return ClosePopup19();"/>
            </td>
            </tr>
                </table>
                </div>
   ...
   <cc1:ModalPopupExtender ID="MdlPayStat" runat="server" PopupControlID="tblUpdate16"
        BackgroundCssClass="ModalPopupBG" TargetControlID="HPSd" CancelControlID="BtnClsSendRegMail4" >
    </cc1:ModalPopupExtender>
    <asp:HiddenField ID="HPSd" runat="server" />
    <div id="tblUpdate16" class="PopUpHolder" style="display: none;"  >
        <div class="main" style="width: 1120px" >
            <h4>
               Payment Process Result
                <asp:LinkButton ID="BtnClsSendRegMail4" runat="server" Text="Close" BorderWidth="0"
                    CssClass="close"></asp:LinkButton>
                <!-- <div class="cls">
            </div> -->
            </h4>
                            ...
                            <tr>
                                <td style="vertical-align: top;">
                                    <asp:UpdatePanel ID="UpdatePanel33" runat="server">
                                        <ContentTemplate>
                                            <div>
                                                <b>Sale ID:&nbsp;<asp:Label ID="Label2" runat="server"></asp:Label></b>
                                            </div>
                                            <div style="width: 100%">
                                            </div>
                                        </ContentTemplate>
                                            ...
                                            <asp:Panel ID="Panel3" Width="100%" runat="server">
                                                <asp:UpdatePanel ID="UpdatePanel39" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <asp:GridView Width="1070px" ID="GridView1" runat="server" CellSpacing="0" CellPadding="0"
                                                            CssClass="grid1" AutoGenerateColumns="False" GridLines="None" ShowHeader="false"
            ...
            <td>
             <asp:Button ID="smartz" CssClass="g-button g-button-submit" runat="server"
            Text="Moved Smartz"  OnClick="smartz_Click" />
            </td>
            <td>
             <asp:Button ID="Button9" CssClass="g-button g-button-submit" runat="server"
            Text="Close" OnClientClick="return ClosePopup20();"/>
            </td>
            </tr>
                </table>
                </div>
