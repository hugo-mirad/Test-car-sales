<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QCDataEditForDealer.aspx.cs"
    Inherits="QCDataEditForDealer" %>
        ...
        <table style="width: 100%">
            ...
            <td>
                <h1 style="border-bottom: none; padding-top: 5px;">
                    UNITED CAR EXCHANGE <span>Dealer QC Data Edit</span></h1>
            </td>
                    ...
                    <asp:UpdatePanel ID="updtpnlSave" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="ddlSaleStatus" runat="server" Font-Size="14px" Font-Bold="true"
                                ForeColor="#2B4BB1" Enabled="false">
                            ...
                            &nbsp;
                            <asp:Button ID="btnSave" runat="server" CssClass="g-button g-button-submit" Text="Update"
                                OnClick="btnSave_Click" OnClientClick="return ValidateSavedData();" />
                            &nbsp;
                            <asp:Button ID="btnAbandon" runat="server" CssClass="g-button g-button-submit" Text="Close"
            ...
            <tr>
                <td width="50%">
                    <h4 class="h4">
                        ...
                        <asp:TextBox ID="txtSaleAgent" runat="server" MaxLength="50" Enabled="false"></asp:TextBox>
                    </h4>
                </td>
                <td>
                    <h4 class="h4">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <h5 style="font-size: 15px; margin: 0; float: left; width: 130px;">
                                                                            Invoice Details</h5>
                                                                        <h5 style="font-size: 12px; font-weight: normal; margin: 0; display: inline-block">
                                                                            <asp:LinkButton ID="lnkbtnCopyInvoiceInfo" runat="server" Text="Copy name & address from dealer information"
