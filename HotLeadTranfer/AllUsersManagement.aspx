<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllUsersManagement.aspx.cs"
    Inherits="AllUsersManagement" %>
   ...
   function  TimerDec(ssTime)
   {
    ...
    <script type="text/javascript" language="javascript">
        ...
        function ValidateAdd() {        
            ...
            var valid = true;
            if(document.getElementById('<%=ddlAddNewCenters.ClientID%>').value =="0")
            {
                alert("Please select center"); 
                valid=false;
                document.getElementById('ddlAddNewCenters').focus();  
                return valid;  
            }
           else if (document.getElementById('<%=txtFName.ClientID%>').value.trim().length < 1) {
                ...
                <table style="width: 720px;">
                    <tr>
                        <td style="vertical-align: top;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: right">
                                                <div align="right" style="width: 220px; text-align: right; float: right">
                                                    <asp:LinkButton ID="lnkAddUSer" runat="server" OnClick="lnkAddUSer_Click" CssClass="pageAction">Add User</asp:LinkButton>
                                ...
                                <asp:UpdatePanel ID="updtPnlHeaders" runat="server">
                                    <ContentTemplate>
                                        <table class="grid1 " cellpadding="0" cellspacing="0" style="position: absolute;
                                            top: 2px; width: 830px; background: #fff; border-top: #fff 2px solid;">
                                            <tr class="tbHed">
                                                ...
                                                <td width="130px" align="left">
                                                    <asp:LinkButton ID="lnkbtnCenterCode" runat="server" Text="Center &darr; &uarr;"
                                                        OnClick="lnkbtnCenterCode_Click"></asp:LinkButton>
                                                </td>
                                                <td align="left">
                            ...
                            <div style="width: 850px; overflow-y: scroll; overflow-x: hidden; padding: 26px 3px 3px 3px;
                                ...
                                <asp:Panel ID="pnl1" Width="100%" runat="server">
                                    <asp:UpdatePanel ID="UpdPnlGrid" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView Width="830px" ID="grdUserDetails" runat="server" CellSpacing="0" CellPadding="0"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCenterCode" runat="server" Text='<%#Eval("AgentCenterCode") %>'></asp:Label>
                                                        </ItemTemplate>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 98%; margin: 0 auto">
                                        <tr>
                                            <td style="width: 100px">
                                                Center<span class="star">*</span>
                                            </td>
                                            <td style="width: 200px">
                                                <asp:DropDownList ID="ddlAddNewCenters" runat="server" AppendDataBoundItems="true"
                                                    AutoPostBack="true" OnSelectedIndexChanged="ddlAddNewCenters_SelectedIndexChanged"
                                                    Width="78%">
                                                </asp:DropDownList>
                                            </td>
                                            <td colspan="3">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel4">
                                                    <ContentTemplate>
                                                        <asp:DropDownList ID="ddlAddUsertype" runat="server" Width="78%" AppendDataBoundItems="true">
                                                        </asp:DropDownList>
                                                    </ContentTemplate>
                                                </asp:UpdatePanel>
                                            </td>
