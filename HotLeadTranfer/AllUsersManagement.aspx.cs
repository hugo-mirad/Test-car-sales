...
public partial class AllUsersManagement : System.Web.UI.Page
{
    ...
    private void FillNewUserTypeBasic()
    {
        try
        {
            ddlAddUsertype.Items.Clear();
    ...
    private void FillAllCenters()
    {
        try
        {
            DataSet dsFillCenters = new DataSet();
            dsFillCenters = objHotLeadBL.GetMasterAgentCenters();
            ddlAddNewCenters.DataSource = dsFillCenters.Tables[0];
            ddlAddNewCenters.DataTextField = "AgentCenterCode";
            ddlAddNewCenters.DataValueField = "AgentCenterID";
            ddlAddNewCenters.DataBind();
            ddlAddNewCenters.Items.Insert(0, new ListItem("Select", "0"));
        }
        catch (Exception ex)
        {
            throw ex;
    ...
    private void FillNewUserType()
    {
        try
        {
            ...
            liCenterRoles.Value = "2";
            liCenterRoles.Text = "Center admin";
    ...
    protected void lnkAddUSer_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            liUserStatus.Value = "0";
            liUserStatus.Text = "Select";
            ddlAddNewCenters.SelectedIndex = ddlAddNewCenters.Items.IndexOf(liUserStatus);
            txtFName.Text = "";
            txtUserName.Text = "";
            txtEmail.Text = "";
            txtPassword.Text = "";
    ...
    private void LoadUsers()
    {
        try
        {
            ...
            DataSet dsUsers = objHotLeadBL.GetUserDetailsForAllUsersManagement();
            Session["AllUserMgmtDetails"] = dsUsers;
    ...
    protected void grdUsers_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        try
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                dsVoice = (DataSet)Session["AllUserMgmtDetails"];
    ...
    protected void btnAddUser_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            int CenterCode = Convert.ToInt32(ddlAddNewCenters.SelectedItem.Value);
                ...
                else
                {
                    if (Convert.ToInt32(ddlAddUsertype.SelectedItem.Value) == 1)
                    {
                        for (int m = 1; m < 10; m++)
                        {
                            if (m == 3)
                            {
                                objHotLeadBL.UpdateModuleRights(Convert.ToInt32(ds.Tables[0].Rows[0]["UID"].ToString()), m, 0);
                            }
                            else if (m == 5)
                            {
                                objHotLeadBL.UpdateModuleRights(Convert.ToInt32(ds.Tables[0].Rows[0]["UID"].ToString()), m, 0);
                            ...
                            {
                                objHotLeadBL.UpdateModuleRights(Convert.ToInt32(ds.Tables[0].Rows[0]["UID"].ToString()), m, 1);
                            }
                    ...
                    if (Convert.ToInt32(ddlAddUsertype.SelectedItem.Value) == 6)
                    {
                        for (int m = 1; m < 10; m++)
                        {
                            if (m == 3)
                    ...
                    if (Convert.ToInt32(ddlAddUsertype.SelectedItem.Value) == 7)
                    {
                        for (int m = 1; m < 10; m++)
                        {
                            if (m == 9)
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                if (Convert.ToInt32(ddlUpdateuserType.SelectedItem.Value) == 6)
                {
                    for (int m = 1; m < 10; m++)
                    {
                        if (m == 3)
                ...
                if (Convert.ToInt32(ddlUpdateuserType.SelectedItem.Value) == 7)
                {
                    for (int m = 1; m < 10; m++)
                    {
                        if (m == 9)
    ...
    protected void grdUsers_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            dsUser = (DataSet)Session["AllUserMgmtDetails"];
            ...
            if (e.CommandName == "view")
            {
                ...
                {
                    FillUpdateUserType();
                    DataSet dsCenterRolesUpdate = objHotLeadBL.GetCenterRolesByID(Convert.ToInt32(dt.Rows[0]["AgentCenterID"].ToString()));
                    ...
                    if (dsCenterRolesUpdate.Tables[0].Rows.Count > 0)
                    {
                        for (int i = 0; i < dsCenterRolesUpdate.Tables[0].Rows.Count; i++)
                        {
                            ...
                            if (dsCenterRolesUpdate.Tables[0].Rows[i]["CenterRoleID"].ToString() == "5")
                            {
                                if (dsCenterRolesUpdate.Tables[0].Rows[i]["CenterRightStatus"].ToString() == "0")
                                {
                                    ListItem liCenterRoles = new ListItem();
    ...
    {
        DataSet dsFillUpdateUserType = new DataSet();
        dsFillUpdateUserType = objHotLeadBL.GetMasterUserType();
        Session["dsFillNewUserType"] = dsFillUpdateUserType;
    ...
    protected void ddlAddNewCenters_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            int CenterCode = Convert.ToInt32(ddlAddNewCenters.SelectedItem.Value);
            ...
            {
                FillNewUserType();
                DataSet dsCenterRoles = objHotLeadBL.GetCenterRolesByID(Convert.ToInt32(CenterCode));
                if (dsCenterRoles.Tables[0].Rows.Count > 0)
                {
                    for (int i = 0; i < dsCenterRoles.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (dsCenterRoles.Tables[0].Rows[i]["CenterRoleID"].ToString() == "5")
                        {
                            if (dsCenterRoles.Tables[0].Rows[i]["CenterRightStatus"].ToString() == "0")
                            {
                                ListItem liCenterRoles = new ListItem();
    ...
    protected void lnkUserName_Click(object sender, EventArgs e)
    {
        try
        {
            Session.Timeout = 180;
            DataSet ds = new DataSet();
            ds = Session["AllUserMgmtDetails"] as DataSet;
            ...
            lnkbtnCenterCode.Text = "Center &darr; &uarr;";
            if (dt != null)
            {
    ...
    protected void lnkbtnCenterCode_Click(object sender, EventArgs e)
    {
        try
        {
            Session.Timeout = 180;
            ...
            {
                Session["SortDirec"] = "Ascending";
                lnkbtnCenterCode.Text = "Center &#8659";
            }
            else if (Session["SortDirec"].ToString() == "")
            {
                Session["SortDirec"] = "Ascending";
            ...
            {
                Session["SortDirec"] = "Descending";
                lnkbtnCenterCode.Text = "Center &#8657";
            }
            else
            {
                Session["SortDirec"] = "Ascending";
