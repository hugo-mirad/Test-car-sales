...
public partial class WeeklySalesByPacakage : System.Web.UI.Page
{
    ...
    double PDTotal = 0, GDTotal = 0, SDTotal = 0, OtherTotal = 0, SubTotaTotal = 0;
    double FPDTotal = 0, FGDTotal = 0, FSDTotal = 0, FOtherTotal = 0, FSubTotaTotal = 0;

    double PDVRTotal = 0, GDVRTotal = 0, SDVRTotal = 0, OtherVRTotal = 0, SubVRTotaTotal = 0;
    double FVRPDTotal = 0, FVRGDTotal = 0, FVRSDTotal = 0, FVROtherTotal = 0, FVRSubTotaTotal = 0;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            txtStartDate.Text = DateTime.Now.AddDays(-6).ToString("MM/dd/yyyy");
    ...
    private void getdetails(string CenterCode, int CenterID)
    {
        try
        {
            ...
            DataSet dsData = objHotLeadBL.GetTotalSalesBycenterByAgentForWeek(CenterID, dtstart, dtEnd);
            DataSet dsDataVerifier = objHotLeadBL.GetTotalSalesBycenterByVerifierForweekDay(CenterID, dtstart, dtEnd);
