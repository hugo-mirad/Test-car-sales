<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WeeklySalesByDay.aspx.cs"
    Inherits="WeeklySalesByDay" %>
...
<body>
        ...
        <table style="width: 100%">
            ...
            <td>
                <h1 style="border-bottom: none; padding-top: 5px;">
                    UNITED CAR EXCHANGE <span>Weekly Sales By Day</span></h1>
            </td>
    ...
    <div class="main" style="width: 90%; min-width: 1100px; margin:10px">
           <table id="Table1" style="width: auto; padding: 10px; border-collapse: initial; border: #ccc 1px solid;
            ...
            <tr>
                ...
                <td style="text-align: left; padding: 0 20px 0 0; vertical-align: middle">
                 ...
                 <b> <span id="lblAge" runat="server" >Centers:</span></b>  <asp:DropDownList ID="ddlCenters" runat="server">
                    </asp:DropDownList>
                </td>
                         ...
                         <div class="scrollY">
                            <table width="500px;" class="grid1">
                                ...
                                <asp:Repeater ID="Rpt_Salescount" runat="server" OnItemDataBound="Rpt_Salescount_ItemDataBound">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblsubPD" runat="server" Text='<%# Eval("MonCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblsubGD" runat="server" Text='<%# Eval("TueCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblsubSD" runat="server" Text='<%# Eval("WedCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblsubothr" runat="server" Text='<%# Eval("ThuCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblsubFri" runat="server" Text='<%# Eval("FriCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblsubSat" runat="server" Text='<%# Eval("SatCount") %>'></asp:Label>
                                            </td>
                                            <td class="bgHash br">
                                                <asp:Label ID="lbltots" runat="server" Text='<%# Eval("Total Count") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblpaidPD" runat="server" Text='<%# Eval("FMonCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblpaidGD" runat="server" Text='<%# Eval("FTueCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblpaidSD" runat="server" Text='<%# Eval("FWedCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblpaidothr" runat="server" Text='<%# Eval("FThuCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblpaidfri" runat="server" Text='<%# Eval("FFriCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblpaidsat" runat="server" Text='<%# Eval("FSatCount") %>'></asp:Label>
                                            </td>
                                            <td class="bgHash br">
                                ...
                                <tr class="foot">
                                    ...
                                    <td style="width: 30px;">
                                        <asp:Label ID="lblFFrid" runat="server"></asp:Label>
                                    </td>
                                    <td style="width: 30px;">
                                        <asp:Label ID="lblFSat" runat="server"></asp:Label>
                                    </td>
                                    <td style="width: 30px;">
                        ...
                        <td style="width: 48%">
                          <fieldset class="set1">
                                ...
                                <asp:Repeater ID="Rpt_Verifierscount" runat="server" OnItemDataBound="Rpt_Verifierscount_ItemDataBound">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="lblVRsubPD" runat="server" Text='<%# Eval("MonCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRsubGD" runat="server" Text='<%# Eval("TueCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRsubSD" runat="server" Text='<%# Eval("WedCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRsubothr" runat="server" Text='<%# Eval("ThuCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRsubFri" runat="server" Text='<%# Eval("FriCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRsubSat" runat="server" Text='<%# Eval("SatCount") %>'></asp:Label>
                                            </td>
                                            <td style="background-color: LightGrey;" class="bgHash br">
                                                <asp:Label ID="lblVRtots" runat="server" Text='<%# Eval("Total Count") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRpaidPD" runat="server" Text='<%# Eval("FMonCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRpaidGD" runat="server" Text='<%# Eval("FTueCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRpaidSD" runat="server" Text='<%# Eval("FWedCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRpaidothr" runat="server" Text='<%# Eval("FThuCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRpaidFri" runat="server" Text='<%# Eval("FFriCount") %>'></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblVRpaidSat" runat="server" Text='<%# Eval("FSatCount") %>'></asp:Label>
                                            </td>
                                            <td style="background-color: LightGrey;" class="bgHash br">
                                ...
                                <tr id="VerifierTotal" runat="server" class="foot">
                                    ...
                                    <td style="width: 30px;">
                                        <asp:Label ID="lblVRsubtFri" runat="server"></asp:Label>
                                    </td>
                                    <td style="width: 30px;">
                                        <asp:Label ID="lblVRsubtSat" runat="server"></asp:Label>
                                    </td>
                                    <td style="width: 30px;">
                                    ...
                                    <td style="width: 30px;">
                                        <asp:Label ID="lblVRFsubtFri" runat="server"></asp:Label>
                                    </td>
                                    <td style="width: 30px;">
                                        <asp:Label ID="lblVRFsubtsat" runat="server"></asp:Label>
                                    </td>
                                    <td style="width: 30px;">
